...
int64 nChainStartTime = 1407547785;
...
const string strMessageMagic = "BlackToken Signed Message:\n";
...
static const int64 nTargetTimespan = 30 * 30; // 30 blocks  
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BlackToken
    bool fStrictPayToScriptHash = true; // Always active in BlackToken
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BlackToken", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "thisis the psz timestamp yo";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xa3e2c050dda5178062a8f9b4834cfb4c6754c33ae7c7679b9d7481b1aa17d854"));
