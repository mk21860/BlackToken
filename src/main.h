...
static const uint256 hashGenesisBlockOfficial("0x000001cb93b0d2049c9882f62cc1f847cc4d57c89b6213137d840654cc3e1465");
static const uint256 hashGenesisBlockTestNet ("0x000001cb93b0d2049c9882f62cc1f847cc4d57c89b6213137d840654cc3e1465");
...
public:
    ...
    std::string ToString() const
    {
        ...
        if (prevout.IsNull())
            str += strprintf(", coinbase %s", HeRETr(scriptSig).c_str());
        else
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        // 1440 blocks a day. Priority cutoff is 1 RET day/ 250 bytes
...
public:
    ...
    void print() const
    {
        printf("CBlock(hash=%s, ver=%d, hashPrevBlock=%s, hashMerkleRoot=%s, nTime=%u, nBits=%08x, nNonce=%u, vtx=%"PRIszu", vchBlockSig=%s)\n",
            ...
            nTime, nBits, nNonce,
            vtx.size(),
            HeRETr(vchBlockSig.begin(), vchBlockSig.end()).c_str());
